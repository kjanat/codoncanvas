<script lang="ts">
  import type { Engine, CodonInfo } from "../lib/engine/index.js";
...
<p class="muted">
  All 64 codons map to an opcode. Many are synonymous (genetic redundancy);
  the real amino acid each codon encodes is shown for biological comparison.
</p>
