...
4. **Accessibility audit + implementation** ← CHOSEN
...
- ✅ **Autonomous Fit:** Clear WCAG checklist, testable criteria
- ✅ **High Impact:** Enables diverse learners (vision, motor, cognitive)
- ✅ **Legal:** ADA compliance for educational tools
...
<!-- After -->
<button id="runBtn" aria-label="Run genome program (Ctrl+Enter)">▶ Run</button>
```
...
- ⚠️ Focus visible enhancement (additional styling for Windows HC)
...
- ✅ Keyboard efficiency for speed tasks
...
- ✅ Navigate with landmarks (screen reader)
...
- ✅ Narrator (Windows) - assumed via ARIA
...
2. **Mobile Responsiveness** (60-90 min)
   - CSS media queries
   - Touch-friendly targets (48×48px min)
