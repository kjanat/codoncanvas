...
import {
  ...
  UnlockNotification,
  useAchievementsDemo,
} from "@/pages/demos/achievements";

function AchievementsDemoPage(): ReactElement {
...
export const Route = createFileRoute("/demos/achievements")({
  component: AchievementsDemoPage,
});
