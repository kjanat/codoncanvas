  ...
  return (
    ...
    >
      <div className="fixed inset-0 z-50">
        {/* Backdrop - decorative overlay, click to close */}
        <div
          aria-hidden="true"
        ...
        <div
          ...
          aria-modal="true"
          className="flex h-full items-center justify-center p-4 pointer-events-none"
          role="dialog"
        >
          <div className="relative max-h-[90vh] w-full max-w-4xl overflow-auto rounded-2xl bg-surface shadow-xl pointer-events-auto">
            {/* Header */}
